...
You will be using Istio version 1.15.0:
...
Note the istio distribution folder `istio-1.15.0` in your home directory:
...
Note how the output of the above command states in so many words that Istio is not yet installed in your Kubernetes cluster, but that the client version is 1.15.0.

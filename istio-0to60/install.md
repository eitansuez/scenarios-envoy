...
You will be using Istio version 1.18.2:
...
Note the istio distribution folder `istio-1.18.2` in your home directory:
...
Note how the output of the above command states in so many words that Istio is not yet installed in your Kubernetes cluster, but that the client version is 1.18.2.
